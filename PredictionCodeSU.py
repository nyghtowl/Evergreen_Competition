...
'''
Stumble Kaggle Competition Submitted Code for 23 rank
'''
...
def cv_predict(rd, X, y, n_folds=25):
  """
...
def main():
  ...
  logr = lm.LogisticRegression(penalty='l2', dual=True, tol=0.0001, C=1.0, fit_intercept=True, intercept_scaling=1.0, class_weight=None, random_state=None)
